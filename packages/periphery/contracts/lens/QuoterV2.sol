...
import '@vapordex/v2-core/contracts/libraries/TickBitmap.sol';
...
contract QuoterV2 is IQuoterV2, IVaporDEXV2SwapCallback, PeripheryImmutableState {
    ...
    function VaporDEXV2SwapCallback(
        ...
        IVaporDEXV2Pool pool = getPool(tokenIn, tokenOut, fee);
        ...
        returns (uint256 amountOut, uint160 sqrtPriceX96After, uint32 initializedTicksCrossed, uint256 gasEstimate)
    {
        ...
        IVaporDEXV2Pool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
