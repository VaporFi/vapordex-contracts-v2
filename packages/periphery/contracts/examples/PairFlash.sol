...
import '@vapordex/v2-core/contracts/interfaces/callback/IVaporDEXV2FlashCallback.sol';
import '@vapordex/v2-core/contracts/libraries/LowGasSafeMath.sol';
...
/// @notice An example contract using the VaporDEX V2 flash function
contract PairFlash is IVaporDEXV2FlashCallback, PeripheryPayments {
    ...
    /// @notice Calls the pools flash function with data needed in `VaporDEXV2FlashCallback`
    function initFlash(FlashParams memory params) external {
        ...
        IVaporDEXV2Pool pool = IVaporDEXV2Pool(PoolAddress.computeAddress(factory, poolKey));
