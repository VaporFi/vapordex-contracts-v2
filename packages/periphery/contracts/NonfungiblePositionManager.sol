...
import '@vapordex/v2-core/contracts/libraries/FixedPoint128.sol';
...
/// @title NFT positions
/// @notice Wraps VaporDEX V2 positions in the ERC721 non-fungible token interface
    ...
    SelfPermit
{
    ...
    ) ERC721Permit('VaporDEX V2 Positions NFT-V1', 'VAPE-V2-POS', '1') PeripheryImmutableState(_factory, _WETH9) {
