...
/// @title VaporDEX V2 Swap Router
/// @notice Router for stateless execution of swaps against VaporDEX V2
    ...
    SelfPermit
{
    ...
    function VaporDEXV2SwapCallback(int256 amount0Delta, int256 amount1Delta, bytes calldata _data) external override {
