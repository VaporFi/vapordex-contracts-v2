import { abi as IVaporDEXV2PoolABI } from '@vapordex/v2-core/artifacts/contracts/interfaces/IVaporDEXV2Pool.sol/IVaporDEXV2Pool.json'
import { Fixture } from 'ethereum-waffle'
import { BigNumber, constants, ContractTransaction, Wallet } from 'ethers'
import { ethers, waffle } from 'hardhat'
import { IVaporDEXV2Pool, IWETH9, MockTimeSwapRouter, TestERC20 } from '../typechain'
...
describe('SwapRouter gas tests', function () {
  ...
  const swapRouterFixture: Fixture<{
    ...
    pools: [IVaporDEXV2Pool, IVaporDEXV2Pool, IVaporDEXV2Pool]
    ...
    const pools = poolAddresses.map((poolAddress) => new ethers.Contract(poolAddress, IVaporDEXV2PoolABI, wallet)) as [
      IVaporDEXV2Pool,
      IVaporDEXV2Pool,
      IVaporDEXV2Pool
    ]
  ...
  let pools: [IVaporDEXV2Pool, IVaporDEXV2Pool, IVaporDEXV2Pool]
  ...
  describe('#exactInput', () => {
    ...
    it('0 -> 1 minimal', async () => {
      const calleeFactory = await ethers.getContractFactory('TestVaporDEXV2Callee')
