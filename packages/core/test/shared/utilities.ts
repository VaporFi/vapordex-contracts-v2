...
export function createPoolFunctions({
  ...
  swapTarget: TestVaporDEXV2Callee
  token0: TestERC20
  token1: TestERC20
  pool: MockTimeVaporDEXV2Pool
}): PoolFunctions {
...
export function createMultiPoolFunctions({
  ...
  swapTarget: TestVaporDEXV2Router
  poolInput: MockTimeVaporDEXV2Pool
  poolOutput: MockTimeVaporDEXV2Pool
}): MultiPoolFunctions {
