...
describe('VaporDEXV2Pool', () => {
  ...
  let pool0: MockTimeVaporDEXV2Pool
  let pool1: MockTimeVaporDEXV2Pool
  ...
  let swapTargetCallee: TestVaporDEXV2Callee
  let swapTargetRouter: TestVaporDEXV2Router
  ...
  beforeEach('deploy first fixture', async () => {
    ...
    ): Promise<[MockTimeVaporDEXV2Pool, any]> => {
