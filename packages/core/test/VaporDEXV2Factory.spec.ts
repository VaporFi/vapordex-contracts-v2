...
describe('VaporDEXV2Factory', () => {
  ...
  const fixture = async () => {
    ...
    return (await factoryFactory.deploy()) as VaporDEXV2Factory
  }
  ...
  before('load pool bytecode', async () => {
    poolBytecode = (await ethers.getContractFactory('VaporDEXV2Pool')).bytecode
  })
  ...
  async function createAndCheckPool(
    ...
    const poolContractFactory = await ethers.getContractFactory('VaporDEXV2Pool')
