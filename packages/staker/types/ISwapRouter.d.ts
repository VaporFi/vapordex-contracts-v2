...
interface ISwapRouterInterface extends ethers.utils.Interface {
  functions: {
    ...
    'VaporDEXV2SwapCallback(int256,int256,bytes)': FunctionFragment
  }
  ...
  encodeFunctionData(
    functionFragment: 'VaporDEXV2SwapCallback',
  ...
  decodeFunctionResult(functionFragment: 'VaporDEXV2SwapCallback', data: BytesLike): Result
...
export class ISwapRouter extends Contract {
  ...
  functions: {
    ...
    'VaporDEXV2SwapCallback(int256,int256,bytes)'(
      amount0Delta: BigNumberish,
      amount1Delta: BigNumberish,
      data: BytesLike,
      overrides?: Overrides
