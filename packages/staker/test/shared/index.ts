...
import { IVaporDEXV2Pool, TestERC20 } from '../../typechain'
...
export const getSlot0 = async (pool: IVaporDEXV2Pool) => {
  if (!pool.signer) {
...
export const getCurrentTick = async (pool: IVaporDEXV2Pool): Promise<number> => (await getSlot0(pool)).tick
